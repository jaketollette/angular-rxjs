...
export class SupplierService {
  ...
  constructor(private http: HttpClient) {
    ...
    // this.suppliersWithMergeMap$.subscribe( item => console.log('mergemap map result', item));
    // this.suppliersWithSwitchMap$.subscribe( item => console.log('switchMap map result', item));
   }
